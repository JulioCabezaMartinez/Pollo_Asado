<footer>
    ...
    <div id="footer-2">
        <p>Sitio web desarrollado por <img style="max-width:150px ; display:inline-block;" src="../../assets/IMG/DonDigital_Footer.webp"></p>
        <p>Copyright 2024 | Aviso legal | Todos los derechos reservados</p>
    </div>
</footer>